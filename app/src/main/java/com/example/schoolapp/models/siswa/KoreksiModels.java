...
public class KoreksiModels {
    private String id_tugas, mapel, modul, Jenis, id_siswa, nama, benar, salah, tanggal, jam, nilai, dikoreksi;

    public KoreksiModels(){

    }

    public KoreksiModels(String id_tugas, String mapel, String modul, String jenis, String id_siswa, String nama, String benar, String salah, String tanggal, String jam, String nilai, String dikoreksi) {
