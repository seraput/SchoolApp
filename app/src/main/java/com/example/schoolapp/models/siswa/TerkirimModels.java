...
public class TerkirimModels {
    private String id_tugas, mapel, modul, jenis, id_siswa, nama, benar, salah, tanggal, jam, nilai, dikoreksi;

    public TerkirimModels(){

    }

    public TerkirimModels(String id_tugas, String mapel, String modul, String jenis, String id_siswa, String nama, String benar, String salah, String tanggal, String jam, String nilai, String dikoreksi) {
