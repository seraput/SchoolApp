 ...
 * Use the {@link SiswaHistoryDikoreksiFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class SiswaHistoryDikoreksiFragment extends Fragment {
    ...
    AdapterListKoreksi adapterListKoreksi;
    public static ArrayList<KoreksiModels> koreksiModelsArrayList = new ArrayList<>();
    KoreksiModels koreksiModels;
     ...
     * @return A new instance of fragment SiswaHistoryDikoreksiFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static SiswaHistoryDikoreksiFragment newInstance(String param1, String param2) {
        SiswaHistoryDikoreksiFragment fragment = new SiswaHistoryDikoreksiFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.siswa_history_dikoreksi_fragment, container, false);
        sessionManager = new SessionManager(getActivity());
//        sharedPreferences = getSharedPreferences("UserInfo",MODE_PRIVATE);
        HashMap<String, String> user = sessionManager.getUserDetail();
        getNis = user.get(SessionManager.NIS);
        ListView listView = view.findViewById(R.id.list_dikoreksi);
        progressBar = view.findViewById(R.id.progress_circular);

        adapterListKoreksi = new AdapterListKoreksi(this.getActivity(), koreksiModelsArrayList);
        listView.setAdapter(adapterListKoreksi);
        CallKoreksi();
        return view;
    }

    public void CallKoreksi(){
        final String txtnis = getNis;
        progressBar.setVisibility(View.VISIBLE);
        StringRequest request = new StringRequest(Request.Method.POST, getKoreksi,
                new Response.Listener<String>() {
                    @SuppressLint("ResourceAsColor")
                    @Override
                    public void onResponse(String response) {
                        koreksiModelsArrayList.clear();
...
//                                        progressDialog.dismiss();
                                        progressBar.setVisibility(View.GONE);
                                        koreksiModels = new KoreksiModels(id_tugas, mapel, modul, jenis, id_siswa, nama, benar, salah, tanggal, jam, nilai, dikoreksi);
                                        koreksiModelsArrayList.add(koreksiModels);
                                    }
                                }
                            }
                        }
